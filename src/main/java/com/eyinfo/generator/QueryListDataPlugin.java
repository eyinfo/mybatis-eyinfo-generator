...
public class QueryListDataPlugin extends PluginAdapter {
    @Override
    public boolean validate(List<String> warnings) {
        return true;
    }

    private void genListPlusForXml(Document document, IntrospectedTable introspectedTable) {
        introspectedTable.removeAttribute("getListPlus");
        ...
        element.addAttribute(new Attribute("id", "getListPlus"));
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        genListPlusForXml(document, introspectedTable);
